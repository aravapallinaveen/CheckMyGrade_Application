...
def generate_students(filename, total_records=1000, students_with_4_courses=250):
    ...
    with open(filename, "w", newline="") as file:
        ...
        writer.writerow(["Email", "First Name", "Last Name", "Course ID", "Grade", "Marks"])  # Updated order
        ...
        while records_generated < total_records:
            ...
            for course_id in student_courses:
                ...
                writer.writerow([email, first_name, last_name, course_id, grade, marks])  # Updated order
                records_generated += 1
